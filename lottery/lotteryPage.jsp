        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                window.clickToDetail = function(id) {
                    window.location.href="/mobile/plugin/dch/smb/lottery/lotteryBuyPage.jsp?itcode="+itcode+"&id="+id;
                }
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smb/lottery/getLotteryData.jsp",
                    data: {"jsonStr" : JSON.stringify({
                        "itcode" : itcode
                    })},
                    dataType: "json",
                    success: function(data) {
                        if (data.success) {
                            ...
                            for(var index = 0; index < hbData.length; index++) {
                                innerHtml += "<div class='aui-card-list' onClick='clickToDetail("+hbData[index].id+")'><div class='aui-card-list-header' style='font-size:140%;'>【第"+hbData[index].id+"期】"+hbData[index].description+"</div><div class='aui-card-list-content' align='center'><img src='../img/lottery_rmb_1.jpg' class='img-responsive center-block' style='height: 130px;width: 93%;'><div class='aui-content-padded'><div class='aui-progress aui-progress-xs'><div class='aui-progress-bar' style='width: "+hbData[index].nowSumAmount/hbData[index].winSumAmount*100+"%;'></div></div></div><font style='text-align: center;color: gray;'><strong id='strOnce'>"+hbData[index].unitPrice+"</strong>&nbsp;SZB/夺宝码&nbsp;&nbsp;每人限购 <strong id='strLimit'>"+hbData[index].limitEveryday+"</strong>&nbsp;次&nbsp;&nbsp;已累计 <strong id='strHaved'>"+hbData[index].nowSumAmount+"</strong>&nbsp;SZB</font></div><div class='aui-card-list-footer' align='center'><p><div><a>点击进入</a></div></p></div></div>";
                            }
                            innerHtml += "<div class='aui-card-list' onClick='clickToDetail("+smbData.id+")'><div class='aui-card-list-header' style='font-size:140%;'>【第"+smbData.id+"期】"+smbData.description+"</div><div class='aui-card-list-content' align='center'><img src='../img/lottery_szb_1.jpg' class='img-responsive center-block' style='height: 130px;width: 93%;'><div class='aui-content-padded'><div class='aui-progress aui-progress-xs'><div class='aui-progress-bar' style='width: "+smbData.nowSumAmount/smbData.winSumAmount*100+"%;'></div></div></div><font style='text-align: center;color: gray;'><strong id='strOnce'>"+smbData.unitPrice+"</strong>&nbsp;SZB/夺宝码&nbsp;&nbsp;每人限购 <strong id='strLimit'>"+smbData.limitEveryday+"</strong>&nbsp;次&nbsp;&nbsp;已累计 <strong id='strHaved'>"+smbData.nowSumAmount+"</strong>&nbsp;SZB</font></div><div class='aui-card-list-footer' align='center'><p><div><a>点击进入</a></div></p></div></div>"
                            for(var index = 0; index < otherData.length; index++) {
                                innerHtml += "<div class='aui-card-list' onClick='clickToDetail("+otherData[index].id+")'><div class='aui-card-list-header' style='font-size:140%;'>【第"+otherData[index].id+"期】"+otherData[index].description+"</div><div class='aui-card-list-content' align='center'><img src='../img/"+otherData[index].backup2+"' class='img-responsive center-block' style='height: 130px;width: 93%;'><div class='aui-content-padded'><div class='aui-progress aui-progress-xs'><div class='aui-progress-bar' style='width: "+otherData[index].nowSumAmount/otherData[index]. winSumAmount*100+"%;'></div></div></div><font style='text-align: center;color: gray;'><strong id='strOnce'>"+otherData[index].unitPrice+"</strong>&nbsp;SZB/夺宝码&nbsp;&nbsp;每人限购 <strong id='strLimit'>"+otherData[index].limitEveryday+"</strong>&nbsp;次&nbsp;&nbsp;已累计 <strong id='strHaved'>"+otherData[index].nowSumAmount+"</strong>&nbsp;SZB</font></div><div class='aui-card-list-footer' align='center'><p><div><a>点击进入</a></div></p></div></div>";
                            }
                ...
                $("#introduce").click(function() {
                    window.location.href="/mobile/plugin/dch/smb/lottery/lotteryIntroduce.jsp";
                });
