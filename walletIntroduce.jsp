        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#liWithdraw").click(function() {
                    ...
                    $("#btnToggle").trigger("click");
                    var innerHtml = "<div><p class='lead'>1、提现是由您的默认钱包账户向您创建的账户进行转账，默认钱包账户要求<code>转账后所剩余额最少为10SMB</code>。</p><img src='./img/walletIntroduce_06.jpg' class='img-rounded img-responsive center-block' style='border: groove;'></div><br>";
