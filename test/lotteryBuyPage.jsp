...
<%
    ...
    String id_ = Util.null2String((String) fu4.getParameter("id"));
 %>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12" align="center" style="margin-top: 5%;">
                    <div style="border: 1px solid #EDEDED;">
                        <img id="bkImg" src=""  class="img-responsive center-block" style="padding-top: 8px;padding-bottom: 5px;">
