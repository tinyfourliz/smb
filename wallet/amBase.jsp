...
<html>
        ...
        <script type="text/javascript">
        	...
        	$(function() {
                $("#btnNew").click(function() {
                    window.location.href="/mobile/plugin/dch/smb/wallet/mnemonic.jsp?itcode="+itcode;
                });

                $("#btnCharge").click(function() {
                    window.location.href="/mobile/plugin/dch/smb/wallet/chargeToDefault.jsp?itcode="+itcode;
                });

                $("#btnWithdraw").click(function() {
                    window.location.href="/mobile/plugin/dch/smb/wallet/withdrawToAccount.jsp?itcode="+itcode;
                });
                ...
                $("#btnRecords").click(function() {
                    window.location.href="/mobile/plugin/dch/smb/wallet/transRecords.jsp?itcode="+itcode;
                });
            });
        </script>
    </head>
    ...
    <footer>
        <div align="center" style="position: absolute; bottom: 20px; height: 5%; width: 100%;">
            <a href="/mobile/plugin/dch/smb/wallet/walletIntroduce.jsp">使用指南</a>
        </div>
    </footer>
</html>