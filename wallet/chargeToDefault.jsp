    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smb/wallet/getChargeDefault.jsp",
                ...
                $("#btnConfirm").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smb/wallet/getChargeConfirm.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "itcode" : itcode,
                            "account" : account,
                            "password" : password,
                ...
                $("#btnQuery").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smb/wallet/getBalanceQuery.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "account" : account
                        })},
                        dataType: "json",
                ...
                $("#btnInputConfirm").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smb/wallet/getChargeFromInputAccount.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "itcode" : itcode,
                            "account" : account,
                            "password" : password,
