...
<%
	...
	// String url = "http://10.7.10.87:8082/paidLottery/lotteryInfo/getCurrentRMBId?param=";
	String url = "http://10.0.3.113:8082/paidLottery/lotteryInfo/getCurrentRMBId?param=";
	try{
