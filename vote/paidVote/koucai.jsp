                            ...
                            success: function(data) {
                                ...
                                $(infoList).each(function(index, value) {
                                    if (value.loginid === itcode) {
                                        window.location.href="/mobile/plugin/dch/smb/vote/paidVote/koucaiVote.jsp?count="+$("#main").text()+"&name="+value.lastname+"/"+itcode+"&dept="+value.depName;
                                    }
                                });
                            },
                        });
                    ...
                    success:function(data){
                        ...
                        $(".weui-media-box").click(function(i,n){
                            ...
                            if($name.search(itcode) != -1){
                                ...
                                window.location.href="/mobile/plugin/dch/smb/vote/paidVote/koucaiVote.jsp?count="+$("#main").text()+"&name="+$name+"&dept="+$dept;
                            }   
                        });
